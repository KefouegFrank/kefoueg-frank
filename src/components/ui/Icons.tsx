...
export const IconTwitter = ({
  ...
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M22.46 6c-.77.35-1.6.58-2.46.69.88-.53 1.55-1.37 1.87-2.36-.83.49-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04.67.11.98-3.56-.18-6.73-1.89-8.84-4.48-.37.63-.58 1.37-.58 2.15 0 1.48.75 2.78 1.89 3.55-.7 0-1.36-.2-1.94-.53v.05c0 2.05 1.46 3.76 3.4 4.15-.36.1-.74.15-1.12.15-.27 0-.54-.03-.8-.08.54 1.68 2.1 2.9 3.95 2.93-1.44 1.13-3.27 1.81-5.25 1.81-.34 0-.67-.02-1-.06 1.87 1.2 4.1 1.9 6.47 1.9 7.75 0 11.99-6.43 11.99-11.99 0-.18 0-.37-.01-.55.82-.59 1.53-1.32 2.09-2.15z" />
  </svg>
);
